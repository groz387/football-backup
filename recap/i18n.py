...
UI: dict[str, dict[str, str]] = {
    "en": {
        ...
        "hook_claim_offside_0": "{n} OFFSIDES.",
        "hook_claim_offside_1": "{team} WALKED INTO THE TRAP {n} TIMES.",
        "hook_claim_offside_2": "THE TRAP FIRED {n} TIMES.",
        "hook_claim_lastkick_0": "THE {n}TH MINUTE.",
        "hook_claim_lastkick_1": "LAST KICK. MINUTE {n}.",
        "hook_claim_lastkick_2": "THEY WAITED UNTIL {n}.",
        "hook_claim_debut_0": "DEBUT. THEN THIS.",
        "hook_claim_debut_1": "{player}. FIRST NIGHT.",
        "hook_claim_debut_2": "A FIRST START. A FIRST PUNCH.",
        "hook_claim_derby_0": "DERBY NIGHT.",
        "hook_claim_derby_1": "{home} AGAINST {away}. DERBY.",
        "hook_claim_table_0": "THE TABLE WAS LISTENING.",
        "hook_claim_table_1": "{team} SAT {n}TH.",
        "hook_claim_sitter_0": "{n} SITTERS. GONE.",
        "hook_claim_sitter_1": "{team} MISSED {n} BIG ONES.",
        "hook_claim_woodwork_0": "{n} OFF THE WOODWORK.",
        "hook_claim_woodwork_1": "THE FRAME SAID NO. {n} TIMES.",
        "hook_claim_setpiece_0": "{n} FROM SET PIECES.",
        "hook_claim_setpiece_1": "DEAD BALL CLINIC. {n}.",
        "hook_claim_howler_0": "THE KEEPER GAVE IT AWAY.",
        "hook_claim_howler_1": "A HOWLER OPENED THE DOOR.",
        "hook_claim_sub_0": "THE BENCH CHANGED IT.",
        "hook_claim_sub_1": "{player} CAME ON. THEN THIS.",
        "hook_claim_var_0": "VAR STEPPED IN.",
        "hook_claim_var_1": "THE SCREEN CHANGED THE MATCH.",
        "hook_claim_prison_0": "{n}% OF THE PASSES. A PRISON.",
        "hook_claim_prison_1": "{team} NEVER GOT OUT.",
        "hook_claim_xgover_0": "{n} xG. MORE GOALS THAN THAT.",
        "hook_claim_xgover_1": "THE FINISHING OUTRAN THE xG.",
        "hook_claim_siege_0": "{n} AT THE FRAME. CLEAN SHEET.",
        "hook_claim_siege_1": "A SIEGE. A BLANK.",
        "hook_claim_rival_0": "RIVAL NIGHT.",
        "hook_claim_rival_1": "{home}. {away}. BLOOD.",
        "hook_claim_star_0": "{player}. {n}.",
        "hook_claim_star_1": "{player} CARRIED THIS.",
        "hook_open_generic_0": "{n} — AND THEN?",
        "hook_open_generic_1": "WHAT DO YOU DO WITH {n}?",
        "hook_open_generic_2": "{team} HAD {n}. STILL...",
        "hook_open_offside_0": "{n} OFFSIDES. WHO GOT ROBBED?",
        "hook_open_lastkick_0": "MINUTE {n}. GUESS WHO.",
        "hook_open_star_0": "{player}. WATCH THIS.",
        "hook_punch_spoiler_0": "THE BOARD WAITED.",
        "hook_punch_spoiler_1": "KEEP WATCHING.",
        "hook_punch_spoiler_2": "THE PAYOFF IS COMING.",
        "hook_punch_spoiler_3": "NOT YET.",
        "hook_bait_motm": "MOTM: {player}. AGREE?",
        "hook_bait_robbery": "ROBBERY?",
        "hook_bait_bottle": "WHO BOTTLED IT?",
        "hook_bait_howler": "HOWLER. WHOSE FAULT?",
        "hook_bait_generic": "WHO WAS YOUR MOTM?",
        "hook_label_offsides": "OFFSIDES",
        "hook_label_sitters": "SITTERS",
        "hook_label_woodwork": "WOODWORK",
        "hook_label_setpiece": "SET PIECE",
        "hook_label_saves": "SAVES",
        "hook_label_minute": "MIN",
    },
    "az": {
        "watermark": "",
