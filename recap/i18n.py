...
UI: dict[str, dict[str, str]] = {
    "en": {
        ...
        "bridge_heat_0": "THE TILE MOSAIC DOES NOT LIE.",
        "bridge_heat_1": "{team} OWNED THESE TILES.",
        "bridge_heat_2": "TILE BY TILE. THE PIN.",
        ...
        "sub_heatmap": "Recorded touch tiles, coloured by the dominant team",
    ...
    "az": {
        ...
        "bridge_heat_0": "PLİTKƏ MOZAIKASI YALAN DEMİR.",
        "bridge_heat_1": "{team} BU PLİTKƏLƏRİ ALDI.",
        "bridge_heat_2": "PLİTKƏ-PLİTKƏ. Sıxışdırma.",
        ...
        "sub_heatmap": "Real toxunuş plitkələri, üstün komandaya görə rənglənib",
    ...
    "es": {
        ...
        "bridge_heat_0": "EL MOSAICO DE CELDAS NO MIENTE.",
        "bridge_heat_1": "{team} DOMINÓ ESTAS CELDAS.",
        "bridge_heat_2": "CELDA A CELDA. EL CLAVO.",
        ...
        "sub_heatmap": "Losas de toques reales, según el equipo dominante",
    ...
    "ru": {
        ...
        "bridge_heat_0": "ПЛИТОЧНАЯ МОЗАИКА НЕ ВРЁТ.",
        "bridge_heat_1": "{team} ЗАБРАЛИ ЭТИ КЛЕТКИ.",
        "bridge_heat_2": "КЛЕТКА ЗА КЛЕТКОЙ. ЗАЖИМ.",
        ...
        "sub_heatmap": "Реальные плитки касаний в цвете доминирующей команды",
...
_OFFLINE_LINES: dict[str, dict[str, str]] = {
    "az": {
        ...
        "THE TILE MOSAIC DOES NOT LIE.": "PLİTKƏ MOZAIKASI YALAN DEMİR.",
    ...
    "es": {
        ...
        "THE TILE MOSAIC DOES NOT LIE.": "EL MOSAICO DE CELDAS NO MIENTE.",
    ...
    "ru": {
        ...
        "THE TILE MOSAIC DOES NOT LIE.": "ПЛИТОЧНАЯ МОЗАИКА НЕ ВРЁТ.",
